...
if (isset($_POST["category"])) {
	...
	echo "
		<div class='nav nav-pills nav-stacked '>
			<li class='active d-block w-100'><a href='#'><h4>Product Categories</h4></a></li>
	";
	if (mysqli_num_rows($run_query) > 0) {
		while ($row = mysqli_fetch_array($run_query)) {
			...
			echo "
					<li class='d-block w-100'><a href='#' class='category' cid='$cid'>$cat_name</a></li>
			";
		}
		echo "</div>";
	}
...
if (isset($_POST["brand"])) {
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active d-block w-100'><a href='#'><h4>Brands</h4></a></li>
	";
	if (mysqli_num_rows($run_query) > 0) {
		while ($row = mysqli_fetch_array($run_query)) {
			$bid = $row["brand_id"];
			...
			echo "
					<li  class='d-block w-100'>  <a href='#' class='selectBrand' bid='$bid'>$brand_name</a></li>
			";
		}
		echo "</div>";
	}
